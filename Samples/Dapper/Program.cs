...
namespace ElasticDapper
{
    ...
    internal class Program
    {
        ...
        private static string s_server = "WVH130\\SQLEXPRESS";
        private static string s_shardmapmgrdb = "ShardMapManagerDatabaseName";
        private static string s_shard1 = "firstshard";
        private static string s_shard2 = "secondSahard";
        private static string s_userName = "sa";
        private static string s_password = "Computer123";
